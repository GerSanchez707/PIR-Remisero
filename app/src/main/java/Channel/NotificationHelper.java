...
public class NotificationHelper extends ContextWrapper {
    ...
    private static final String CHANNEL_ID= "com.PIR.pir";
    private static final String CHANNEL_NAME= "pir";
    ...
    private void createChannels() {
        ...
        notificationChannel.setLightColor(android.R.color.darker_gray); //revisar
