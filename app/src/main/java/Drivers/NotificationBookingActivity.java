...
public class NotificationBookingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonAccept= findViewById(R.id.btnCancelBooking);
        ...
        mMediaPlayer=MediaPlayer.create(this,R.raw.parabensmusic);
      ...
      mListener =  mClientBookingProvider.getClientBooking(mExtraIdClient).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    Toast.makeText(NotificationBookingActivity.this,"El cliente cancelo el Viaje",Toast.LENGTH_LONG);
