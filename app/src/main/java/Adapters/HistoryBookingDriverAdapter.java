...
import Clients.HistoryBookingDetailClientActivity;
import Drivers.HistoryBookingDetailDriverActivity;
...
public class HistoryBookingDriverAdapter  extends FirebaseRecyclerAdapter<HistoryBooking, HistoryBookingDriverAdapter.ViewHolder>
{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder (View view){
            super(view);
            mView= view;
            textViewName= view.findViewById(R.id.TextViewNombre);
            textViewOrigin= view.findViewById(R.id.TextViewOrigen);
